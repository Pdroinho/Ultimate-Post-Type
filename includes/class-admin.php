...
class UPT_Admin
{
     ...
     */
    private static function render_show_all_button() {
        if (!is_admin() || empty($_GET['upt_show_all']) && empty($_GET['taxonomy']) && empty($_GET['post_type'])) {
            return;
        }
    ...
    public static function enqueue_admin_scripts($hook)
    {
        ...
        if ($hook === $importer_hook) {
            ...
            wp_enqueue_script('upt-import-wizard', plugin_dir_url(__FILE__) . '../assets/js/admin/import-wizard.js', ['jquery'], filemtime(plugin_dir_path(__FILE__) . '../assets/js/admin/import-wizard.js'), true);
            wp_localize_script('upt-import-wizard', 'upt_ajax', [
                'ajax_url' => admin_url('admin-ajax.php'),
                'nonce'    => wp_create_nonce('upt_ajax_nonce'),
            ]);
        }

        if ($hook === $importer_hook && false) {
...
?>
    ...
    public static function create_admin_page_gallery()
    {
        ...
        require __DIR__ . '/admin-templates/gallery.php';
    }
    ...
    public static function create_admin_page_importer()
    {
        ...
        require __DIR__ . '/admin-templates/importer.php';
    }

    public static function create_admin_page_schema_builder()
    {
        require __DIR__ . '/admin-templates/schema-builder.php';
    }
...
elseif (isset($_POST['action']) && $_POST['action'] === 'upt_save_schema_settings') {
    ...
    public static function create_admin_page_about()
    {
        ...
        require __DIR__ . '/admin-templates/about.php';
    }
    ...
    public static function create_admin_page_unused_media()
    {
        ...
        require __DIR__ . '/admin-templates/unused-media.php';
    }
